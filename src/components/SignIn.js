            ...
            <div className='flex justify-center'>
                <div className='p-5 shadow-md border rounded-md w-11/12 sm:w-2/3 lg:w-1/2 2xl:w-1/3 my-12' style={{ minWidth: '250px', maxWidth: '800px' }}>
                    ...
                    <form className='flex flex-col gap-3 px-3' onSubmit={handleSignIn}>
                        <input className='border-gray-400 border-t-0 border-r-0 border-l-4 focus:ring-0 shadow' type="email" name="email" placeholder='Email Address' required />
                        <input className='border-gray-400 border-t-0 border-r-0 border-l-4 focus:ring-0 shadow' type="password" name="password" placeholder='Password' required />
